  ...
  return (
    <DashboardLayout>
      <div className="w-5/7 h-5/7 my-6 mx-10 bg-white font-extrabold align-middle rounded-md shadow-2xl overflow-hidden">
        ...
        <h1 className='font-extrabold text-transparent text-3xl bg-clip-text bg-gradient-to-r from-gray-700 to-red-700'> Add User</h1>
        </div>
        <div className='flex flex-row h-full items-center w-full px-6 py-8 overflow-hidden'>
        <form  className='flex-1 flex flex-col w-5/6 justify-start items-center'>
         ...
         <Input className='my-2 w-5/6' type='file'></Input>
        </form>
...
<select name="cars" id="cars" onClick={(e)=>{
...
<Input className='mt-2 w-5/6' placeholder='Current Semester'></Input>
         <Input className='mt-2 w-5/6' placeholder='Current Gpa'></Input>
</form>
}
          </div>
        </div>
